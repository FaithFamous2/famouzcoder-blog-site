...
const handleEdit = async (comment, commentContent) => {
    setComments(
        comments.map((c) =>
        c._id === comment._id ? {...c, content: commentContent}: c
        )
    );
};
            ...
            <Modal.Body>
                <div className="text-center">
                    ...
                    <div className='flex justify-center gap-4'>
                        <Button color='failure' onClick={() => handleDelete(commentToDelete)}> Yes, I'm sure
                        </Button>
